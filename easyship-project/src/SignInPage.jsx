...
<div class="py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="hidden lg:block lg:w-1/2 bg-cover"
         style={{ backgroundImage: `url(${signIn})` }} // Use the imported image here
         >
        </div>
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-700 text-center">Easy Ship</h2>
            ...
            <div class="mt-8">
                <button class="bg-orange-600 text-white font-bold py-2 px-4 w-full rounded hover:bg-orange-700">Login</button>
            </div>
            <div class="mt-4 flex items-center justify-between">
