				...
				<div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
					...
					<form class="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded">
						...
						<div class="mb-6 text-center">
							<button
                                class="w-full px-4 py-2 font-bold text-white bg-orange-500 rounded-full hover:bg-orange-700 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-900 focus:outline-none focus:shadow-outline"
                                type="button"
                            >
                                Register Account
                            </button>
						...
						<div class="text-center">
							<a class="inline-block text-sm text-orange-500 dark:text-blue-500 align-baseline hover:text-orange-800"
								href="#">
								Forgot Password?
							</a>
						</div>
