...
>
  ...
  >
    ...
    ></path>
          ...
          <div className={`items-center justify-between w-full lg:flex lg:w-auto lg:order-1 ${mobileMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu-2">
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <Link smooth to="/#home" className="nav-link" onClick={toggleMobileMenu}>Home</Link>
              </li>
              <li>
                <Link smooth to="/#feature" className="nav-link" onClick={toggleMobileMenu}>Features</Link>
              </li>
              <li>
                <Link smooth to="/#courier" className="nav-link" onClick={toggleMobileMenu}>Couriers</Link>
              </li>
              {/* <li>
              <Link smooth to="/#price" className="nav-link">Pricing</Link>
              </li> */}
              <li>
                <a href="/#aboutUs" className="nav-link" onClick={toggleMobileMenu}>About Us</a>
              </li>
              <li>
