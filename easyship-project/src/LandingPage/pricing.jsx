  ...
  return (
    ...
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
            <h1 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Designed for E-Commerce Store
                Teams like yours</h1>
            <p class="mb-5 font-sans text-gray-400 sm:text-xl dark:text-gray-400">Our Focus is To Automate
            ...
            <div
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                    <li class="flex items-center space-x-3">
                        ...
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-800 dark:text-green-400" fill="currentColor"
                    ...
                    <FontAwesomeIcon icon={faTimes} className="text-orange-500 dark:text-red-400" />
...
<span>Role Base Access</span>
            ...
            <div
                ...
                <p class="font-sans text-gray-500 sm:text-lg dark:text-gray-400">Relevant for Medium Sized Teams</p>
                <div class="flex items-baseline justify-center my-8">
...
<FontAwesomeIcon icon={faTimes} className="text-orange-500 dark:text-orange-400" />
<span>Role Base Access</span>
</li>
            ...
            <div
                ...
                <p class="font-sans text-gray-500 sm:text-lg dark:text-gray-400">Best for large scale uses and
                    Enterprises.</p>
                <div class="flex items-baseline justify-center my-8">
